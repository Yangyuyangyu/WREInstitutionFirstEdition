...
/**
 * Created by Administrator on 2016/5/10.ExamMenueBean
 */
public class ExamMenueAdapter extends BaseAdapter {
    private Context mContext;

    public List<ExamMenueBean> reviewList;

    public ExamMenueAdapter(Context mContext, List<ExamMenueBean> list) {
        super();
        this.mContext = mContext;
        this.reviewList = list;
    }

    public void changeManagerData(List<ExamMenueBean> list) {
        this.reviewList = list;
