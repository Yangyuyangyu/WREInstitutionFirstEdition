...
import com.example.administrator.weiraoeducationinstitution.adapter.manage.Manage_TelePhoneInterViewAdapter;
...
public class Manage_TelePhone_Interview extends BaseActivity {
    private static String TAG = "Manage_TelePhone_Interview";
    ...
    private Manage_TelePhoneInterViewAdapter mBookAdapter;
    ...
    protected int setLayoutResourceID() {
        return R.layout.activity_manage_tele_phone_interview;
    }
    ...
    protected void initView() {
        ...
        mRecyclerView = customFindViewById(R.id.manage_telephone_interview_recyclerview);
        mBookAdapter = new Manage_TelePhoneInterViewAdapter(this, new ArrayList<AssociationBean>());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.toolbar_action_search) {
            ...
            bundle.putString("isRepairOrTel","thisIsTel");
