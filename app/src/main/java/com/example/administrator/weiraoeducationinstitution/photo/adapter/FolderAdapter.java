package com.example.administrator.weiraoeducationinstitution.photo.adapter;
...
import com.example.administrator.weiraoeducationinstitution.photo.activity.AlbumActivity;
import com.example.administrator.weiraoeducationinstitution.photo.activity.ShowAllPhoto;
import com.example.administrator.weiraoeducationinstitution.photo.util.BitmapCache;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(
                    R.layout.plugin_camera_select_folder, parent, false);
